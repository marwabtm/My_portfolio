...
const HireMe = () => {
    return (
        <div className="fixed left-4 bottom-4 flex items-center justfy-center overflow-hidden">
            <div className="w-40 h-auto flex items-center justify-center relative animate-spin animate-spin-slow">
