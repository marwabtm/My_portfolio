...
const HireMe = () => {
    return (
        <div className="fixed left-4 bottom-4 flex items-center justfy-center overflow-hidden lg:bottom-10 lg:left-auto md:right-4 md:top-[-15px] md:bottom-auto md:absolute ">
